        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <button onclick="doExport('#datainfo',{type:'excel'});" class="btn btn-success btn-sm btn-flat"><span class="glyphicon glyphicon-print"></span> CSV</button>
               <button onclick="doExport('#datainfo',{type:'pdf'});" class="btn btn-success btn-sm btn-flat"><span class="glyphicon glyphicon-print"></span> PDF</button>

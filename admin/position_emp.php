...
function getRow(id){
  $.ajax({
    ...
    success: function(response){
      ...
      $('#position_val').val(response.position).html(response.description);
      $('#campaign_val').val(response.campaign).html(response.campaign_name);
      $('#batch_val').val(response.batch).html(response.batch);
